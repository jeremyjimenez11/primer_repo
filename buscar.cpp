...
void buscar_por_categoria(tlistaLibros lista, int num_categoria)
{
    ...
    case 0:
    {
        ...
        for (int i = 0; i < lista.contador_libros; i++)
        {
            if (lista.ele_libros[i].genero == "Ciencia ficcion")
            {
                contador++;
    ...
    case 1:
    {
        ...
        rlutil::locate(8, 8);
        rlutil::setColor(rlutil::COLOR::BLACK);
        cout << "Los libros de la categoría " << "\"" << "terror" << "\"" << " son: ";
        for (int i = 0; i < lista.contador_libros; i++)
        {
            if (lista.ele_libros[i].genero == "Terror")
            {
                contador++;
                rlutil::locate(9, 9 + contador);
                rlutil::setColor(rlutil::COLOR::LIGHTMAGENTA);
    ...
    case 2:
    {
        ...
        rlutil::locate(8, 8);
        rlutil::setColor(rlutil::COLOR::BLACK);
        cout << "Los libros de la categoría " << "\"" << "novela gotica" << "\"" << " son: ";
        for (int i = 0; i < lista.contador_libros; i++)
        {
            if (lista.ele_libros[i].genero == "Novela gotica")
            {
                contador++;
                rlutil::locate(9, 9 + contador);
                rlutil::setColor(rlutil::COLOR::LIGHTMAGENTA);
    ...
    case 3:
    {
        ...
        rlutil::locate(8, 8);
        rlutil::setColor(rlutil::COLOR::BLACK);
        cout << "Los libros de la categoría " << "\"" << "fantasia" << "\"" << " son: ";
        for (int i = 0; i < lista.contador_libros; i++)
        {
            if (lista.ele_libros[i].genero == "Fantasia")
            {
                contador++;
                rlutil::locate(9, 9 + contador);
                rlutil::setColor(rlutil::COLOR::LIGHTMAGENTA);
    ...
    case 4:
    {
        ...
        rlutil::locate(8, 8);
        rlutil::setColor(rlutil::COLOR::BLACK);
        cout << "Los libros de la categoría " << "\"" << "misterio" << "\"" << " son: ";
        for (int i = 0; i < lista.contador_libros; i++)
        {
            if (lista.ele_libros[i].genero == "Misterio")
            {
                contador++;
                rlutil::locate(9, 9 + contador);
                rlutil::setColor(rlutil::COLOR::LIGHTMAGENTA);
