...
int main()
{
    ...
    else
    {
        ...
        Guardar(lista_de_libros); //Almacenar datos en el archivo "Libros.txt" 
    }
...
int Menu_Categoria()
{
    ...
    while (true)
    {
        ...
        ColorSeleccion("|      Ciencia Ficcion     |", Columna, FILA + 1, subir_bajar == 0);
        ColorSeleccion("|          Terror          |", Columna, FILA + 2, subir_bajar == 1);
        ColorSeleccion("|       Novela gotica      |", Columna, FILA + 3, subir_bajar == 2);
        ColorSeleccion("|         Fantasia         |", Columna, FILA + 4, subir_bajar == 3);
        ColorSeleccion("|         Misterio         |", Columna, FILA + 5, subir_bajar == 4);
